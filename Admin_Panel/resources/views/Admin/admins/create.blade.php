...
@section('content')
    <div class="container mt-5">
        ...
        @if (isset($success))
            <?php echo $success; ?>
        @endif
        <form action="{{ route('admins.add') }}" method="POST" enctype="multipart/form-data">
            @csrf
            {{-- @method('put') --}}
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name='name' class="form-control @error('name') is-invalid @enderror"
                        id="name" placeholder="Enter product name in English" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="role" class="form-control @error('role') is-invalid @enderror"
                        id="role" placeholder="Enter product name in Arabic" value="{{ old('role') }}">
                    @error('role')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control @error('phone') is-invalid @enderror" placeholder="phone" type="text"
                        name="phone" id="phone">
                </div>
            </div>
            <div class="form-row">
                    ...
                    <div class="gr">
                        ...
                        <div id="f" class="form-check">
                                ...
                                <input type="checkbox" name="permissions[]" class=" form-check-input @error('permissions') is-invalid @enderror"
                                    id="permissions" placeholder="Enter product permissions" value="{{ $permission->id }}">
